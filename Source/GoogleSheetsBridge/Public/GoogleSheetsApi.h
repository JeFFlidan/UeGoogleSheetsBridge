...
{
public:
	static void SendGetRequest(const FGoogleSheetsApiParams_GET& Params, FOnResponse OnResponseReceived);
	static void SendPostRequest(const FGoogleSheetsApiParams_POST& Params, FOnResponse OnResponseReceived);
